...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        connect: {
            options: {
                port: 9000,
                open: false, //change to true if we want to open it at startup
                livereload: 35729,
        ...
        shell: {
            ...
            target: {
                command: "nodemon --debug --harmony_classes --ignore 'node_modules/**' --ignore 'server/conditions' server/index.js --debug true"
            }
        },
    ...
    grunt.registerTask('nodemonDebug', [
        'shell'
    ]);
